...
var chatIconMessage = "", chatIconColor = "";
        ...
        load: function (Args) {
            if (Args) {
                ...
                if (_args.length > 0) {
                    ...
                    chatContent = chatContent + '<div id="TelebuChat-icon" class="iconBlock"><div class="notification animated"><div class="message"> <div id="chatMessage">' + chatIconMessage + '</div></div></div> <div class="chatIcon" ><span class="chat_notify animated zoomIn" style="display:none;"  id="notificationCount"></span><div class="iconDots animated zoomIn"><span> '
                    ...
                    f.className = "mainSection iconTheme"; f.id = chatIconColor; f.innerHTML = chatContent;
...
function GetWidget() {
    ...
    $.ajax({
        url: url +"accounts/40/widgets/llSbLYfCipcQvrSALW22OtLJonRmYZHO",
        type: "GET",
        async: false,
        dataType: "JSON",
        data: {},
        success: function (res) {
            ...
            if (res.Success == true) {
                ...
                chatIconMessage = res.widgets.CustomMessageForChatIcon;
                chatIconColor = res.widgets.WidgetThemes.Color;
